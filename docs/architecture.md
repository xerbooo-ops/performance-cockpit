...
Dieses Dokument beschreibt die Architektur des Performance Cockpits ab Release 0.7. Die wesentlichen Technologieentscheidungen sind in den [Architecture Decision Records](adr/) dokumentiert.
